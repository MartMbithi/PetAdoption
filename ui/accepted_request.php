                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-sm-7">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="accepted_requests">Accepted Requests</a></li>
                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#add_rating">Rate This Driver</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pay_booking">Add Payment</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#delete_account">Delete Accepted Request</a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-line">
                                                                    <select class="form-control show-tick" name="accepted_request_driver_id">
                                                                        ...
                                                                        <?php
                                                                        $driver_ret = "SELECT * FROM driver";
                                                                        $driver_stmt = $mysqli->prepare($driver_ret);
                                                                        $driver_stmt->execute(); //ok
                                                                        $driver_res = $driver_stmt->get_result();
                                                                        while ($driver = $driver_res->fetch_object()) {
                                                                        ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="pay_booking">
                                        <div class="wrap-reset">
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="row clearfix">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-line">
                                                                    <select class="form-control show-tick" name="payment_mode">
                                                                        <option>Mpesa</option>
                                                                        <option>Cash</option>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="hidden" value="<?php echo $req->accepted_request_id; ?>" name="payment_accepted_request_id" required class="form-control" />
                                                                    <input type="text" value="<?php echo $req->request_total_amount; ?>" name="payment_amount" required class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="Add_Payment" class="btn btn-link waves-effect">ADD PAYMENT</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>

                                    <div role="tabpanel" class="tab-pane" id="add_rating">
                                        <div class="wrap-reset">
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="row clearfix">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-line">
                                                                    ...
                                                                    <input type="hidden" value="<?php echo $req->accepted_request_id; ?>" name="rating_accepted_requested_id" required class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-line">
                                                                    <textarea rows="5" id="editor" type="text" name="rating_description" required class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="Add_Rating" class="btn btn-link waves-effect">ADD RATING</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="delete_account">
                                            ...
                                            <div class="modal-body">
                                                <div class="row clearfix">
                                                    ...
                                                    <h2 class="card-inside-title  text-danger text-center">
                                                        Heads Up!, you are about to delete this accepted request.
                                                        This action is reversible, the system will permanently delete this acceptance request records and any other related records too.
                                                    </h2>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#delete_modal">DELETE</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form method="POST">
                        <div class="modal-body text-center text-danger">
                            ...
                            <input type='submit' name="Delete_Accepted_Request" class="text-center btn btn-danger" value="Yes, Delete" />
                        </div>
                    </form>
                </div>
            </div>
