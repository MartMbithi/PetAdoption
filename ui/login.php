                    ...
                    <div class="card">
                        ...
                        <form class="" id="sign_in" method="POST">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" required name="login_user_name" class="form-control">
                            ...
                            <input type="submit" value="SIGN IN" class="btn btn-raised waves-effect bg-red" name="login" /><br>
                            <hr>
                            <a data-toggle="modal" data-target="#driver_modal" class="btn btn-raised waves-effect">SIGN UP AS DRIVER</a>
                            <a data-toggle="modal" data-target="#customer_modal" class="btn btn-raised waves-effect">SIGN UP AS CUSTOMER</a>
