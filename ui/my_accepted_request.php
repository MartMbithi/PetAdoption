                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-sm-7">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="my_accepted_requests">Accepted Requests</a></li>
                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#pay_booking">Add Payment</a></li>
                                </ul>

                                <!-- Tab panes -->
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="pay_booking">
                                        <div class="wrap-reset">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="Add_My_Payment" class="btn btn-link waves-effect">ADD PAYMENT</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="add_rating">
                                        <div class="wrap-reset">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="Add_Driver_Rating" class="btn btn-link waves-effect">ADD RATING</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
