        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="card">
                        <h4 class="l-login">Forgot Password? <div class="msg">Enter your login username below to reset your password.</div>
                        </h4>
                        <form class="" id="sign_in" method="POST">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="email" required name="login_user_name" class="form-control">
                                    <label class="form-label">Enter Login Username</label>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-12">
                                    <input type="submit" value="RESET MY PASSWORD" class="btn btn-raised waves-effect bg-red" name="reset_password_step_1" /><br>
                                </div>
                                <div class="col-12"> <a href="../">Sign In!</a> </div>
                            </div>
                        </form>
                    </div>
                </div>
