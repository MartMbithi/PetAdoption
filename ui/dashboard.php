                        ...
                        <div class="body">
                            <div class="media">
                                <div class="media-icon bg-amber">
                                    <i class="zmdi zmdi-account-calendar zmdi-hc-2x"></i>
                                </div>
                                <div class="media-text">
                                    <span class="title">Drivers </span>
                                    <span class="value"><?php echo $driver; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="body">
                            <div class="media">
                                <div class="media-icon bg-blue">
                                    <i class="zmdi zmdi-car zmdi-hc-2x"></i>
                                </div>
                                <div class="media-text">
                                    <span class="title">Registered Vehicles</span>
                                    <span class="value"><?php echo $car; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card widget-stat">
                        <div class="body">
                            <div class="media">
                                ...
                                <div class="media-text">
                                    <span class="title">Accepted Booking Requests</span>
