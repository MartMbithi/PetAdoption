                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a href="customer?view=<?php echo $customers->customer_id; ?>">
                                                <?php echo $customers->customer_first_name . ' ' . $customers->customer_other_names; ?>
                                            </a>
                                        </td>
                                        <td><?php echo $customers->customer_email; ?></td>
                                        <td><?php echo $customers->customer_mobile_no; ?></td>
                                    </tr>
                                <?php
                                } ?>
                            </tbody>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="largeModalLabel">Register New Customer</h4>
                </div>
                <form method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="Register_Customer" class="btn btn-link waves-effect">ADD CUSTOMER</button>
