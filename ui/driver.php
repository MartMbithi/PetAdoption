                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#delete_account">Delete Driver Account</a></li>
                                </ul>
                                            ...
                                            <div class="modal-body">
                                                <div class="row clearfix">
                                                    ...
                                                    <h2 class="card-inside-title  text-danger text-center">
                                                        Heads Up!, you are about to delete <b><?php echo $driver->driver_first_name . ' ' . $driver->driver_other_names; ?></b> customer account.
                                                        This action is reversible, the system will permanently delete <b><?php echo $driver->driver_first_name . ' ' . $driver->driver_other_names; ?></b>
                ...
                <div class="modal-content">
                    ...
                    <form method="POST">
                        <div class="modal-body text-center text-danger">
                            <h4>Delete <?php echo $driver->driver_first_name . ' ' . $driver->driver_other_names; ?> ?</h4>
                            <br>
                            <p>Heads Up, You are about to delete <?php echo $driver->driver_first_name . ' ' . $driver->driver_other_names; ?>. This action is irrevisble.</p>
                            <button type="button" class="text-center btn btn-success" data-dismiss="modal">No</button>
                            <input type="hidden" name="driver_login_id" value="<?php echo $driver->driver_login_id; ?>">
                            <input type='submit' name="Delete_Driver" class="text-center btn btn-danger" value="Yes, Delete" />
                        </div>
                    </form>
                </div>
            </div>
