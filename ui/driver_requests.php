                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a href="driver_request?view=<?php echo $cars->request_id; ?>">
                                                <?php echo $cars->request_ref; ?>
                                            </a>
                                        </td>
                                        <td>
                                            <b>Reg No:</b> <?php echo $cars->car_reg_no; ?><br>
                                            <b>Model: </b><?php echo $cars->car_model; ?><br>
                                            <b>Color: </b><?php echo $cars->car_color; ?>
                                        </td>
