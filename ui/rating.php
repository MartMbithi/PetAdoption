                                        ...
                                        <div class="wrap-reset">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="Update_Rating" class="btn btn-link waves-effect">UPDATE RATING</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <form method="POST">
                        <div class="modal-body text-center text-danger">
                            ...
                            <input type='submit' name="Delete_Rating" class="text-center btn btn-danger" value="Yes, Delete" />
                        </div>
                    </form>
                </div>
            </div>
