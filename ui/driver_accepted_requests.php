            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-sm-7">
                        <h2>My Accepted Driving Requests </h2>
                        <ul class="breadcrumb">
                        ...
                        <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a href="driver_accepted_request?view=<?php echo $req->accepted_request_id; ?>">
                                                <?php echo $req->request_ref; ?>
                                            </a>
                                        </td>
                                        <td>
                                            <b>From:</b> <?php echo $req->request_source_coodinates; ?> <br>
                                            <b>To : </b><?php echo $req->request_destination_coodinates; ?> <br>
                                            <b>Date: </b><?php echo date('d M Y g:ia', strtotime($req->request_date . $req->request_time)); ?> <br>
                                            <b>Budget: </b> Ksh <?php echo number_format($req->request_total_amount, 2); ?>
                                        </td>
                                        <td>
                                            <b>Departure: </b><?php echo $req->accepted_request_coodinates; ?> <br>
                                            <b>Date: </b><?php echo date('d M Y g:ia', strtotime($req->accepted_request_date . $req->accepted_request_time)); ?>
                                        </td>
                                        <td>
                                            <b>Name: </b> <?php echo $req->customer_first_name . ' ' . $req->customer_other_names; ?> <br>
                                            <b>Contacts: </b><?php echo $req->customer_mobile_no; ?> <br>
                                        </td>
                                        <td>
