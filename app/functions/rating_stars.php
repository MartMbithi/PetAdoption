...
/* Load Rating Stars */
if ($rate->rating_stars == '1') { ?>
    <i class="zmdi zmdi-star"></i>
<?php } else if ($rate->rating_stars == '2') { ?>
    <i class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i>
<?php } else if ($rate->rating_stars == '3') { ?>
    <i class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i>
<?php } else if ($rate->rating_stars == '4') { ?>
    <i class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i>
<?php } else if ($rate->rating_stars == '5') { ?>
