...
if (isset($_POST['Update_Rating'])) {
    ...
    $rating_id = mysqli_real_escape_string($mysqli, $_POST['rating_id']);

    /* Persist */
    $sql = "UPDATE rating SET rating_stars = '{$rating_stars}', rating_description = '{$rating_description}' WHERE rating_id = '{$rating_id}'";
...
if (isset($_POST['Update_My_Rating'])) {
    $rating_stars = mysqli_real_escape_string($mysqli, $_POST['rating_stars']);
    $rating_description = mysqli_real_escape_string($mysqli, $_POST['rating_description']);
    $rating_id = mysqli_real_escape_string($mysqli, $_POST['rating_id']);
...
if (isset($_POST['Delete_Rating'])) {
    ...
    /* Prepare */
    if (mysqli_query($mysqli, $sql)) {
        $_SESSION['success'] = 'Rating Deleted';
        header('Location: ratings');
        exit;
    }
}

if (isset($_POST['Delete_My_Rating'])) {
    $rating_id = mysqli_real_escape_string($mysqli, $_POST['rating_id']);
